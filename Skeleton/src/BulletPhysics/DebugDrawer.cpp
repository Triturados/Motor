...
bool LoveEngine::Physics::OgreDebugDrawer::frameStarted(const Ogre::FrameEvent& evt)
{
...
bool LoveEngine::Physics::OgreDebugDrawer::frameEnded(const Ogre::FrameEvent& evt)
{
...
LoveEngine::Physics::OgreDebugDrawer::OgreDebugDrawer(Ogre::SceneManager* scm)
{
    mContactPoints1_ = {};
    mContactPoints2_ = {};
...
LoveEngine::Physics::OgreDebugDrawer::~OgreDebugDrawer()
{
...
void LoveEngine::Physics::OgreDebugDrawer::drawLine(const btVector3& from, const btVector3& to, const btVector3& color)
{
...
void LoveEngine::Physics::OgreDebugDrawer::drawTriangle(const btVector3& v0, const btVector3& v1, const btVector3& v2, const btVector3& color, btScalar alpha)
{
...
void LoveEngine::Physics::OgreDebugDrawer::drawContactPoint(const btVector3& PointOnB, const btVector3& normalOnB, btScalar distance, int lifeTime, const btVector3& color)
{
...
void LoveEngine::Physics::OgreDebugDrawer::reportErrorWarning(const char* warningString)
{
    Ogre::LogManager::getSingleton().getDefaultLog()->logMessage(warningString);
}

void LoveEngine::Physics::OgreDebugDrawer::draw3dText(const btVector3& location, const char* textString)
{
}

void LoveEngine::Physics::OgreDebugDrawer::setDebugMode(int debugMode)
{
    mDebugModes_ = static_cast<DebugDrawModes>(debugMode);
}

int LoveEngine::Physics::OgreDebugDrawer::getDebugMode() const
{
    return mDebugModes_;
}
