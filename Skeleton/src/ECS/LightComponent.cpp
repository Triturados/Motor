...
//		entityNode->setPosition(pos->getPos().getOgreVector());
//		break;
//	case directional:
//		light = scnMgr->createLight(name);
//
...
//
//
//		entityNode->setPosition(pos->getPos().getOgreVector()); //CAMBIAR AL TRANSFORM
//
...
//}
//
//Vector3<float> LightComponent::getSpecularColor()
//{
//	return Vector3<float>(light->getSpecularColour());
//}
//
...
//}
//
//Vector3<float> LightComponent::getDiffuseColor()
//{
//	return Vector3<float>(light->getDiffuseColour());
//}
//
//
//void LightComponent::setDir(Vector3<float> direction)
//{
